...
export class TrabajoDeGradoService {
    ...
    createTrabajoDeGrado(estudianteId: number) {
    ...
    getTrabajoDeGrado(trabajoGradoId: number) {
    ...
    listTrabajosDeGradoPorEstado(estados: number[]): Observable<any> {
        ...
        estados.forEach((estado) => {
            params = params.append('estados', estado.toString());
        });
    ...
    deleteTrabajoDeGrado(trabajoGradoId: number) {
