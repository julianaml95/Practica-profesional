...
export enum EstadoProceso {
    ...
    PENDIENTE_SUBIDA_ARCHIVOS_COORDINADOR_FASE2_GENERACION_RESOLUCION = 'Pendiente resolucion de informacion por parte del coordinador con respuesta de comite',
    PENDIENTE_SUBIDA_ARCHIVOS_COORDINADOR_FASE3_GENERACION_RESOLUCION = 'Pendiente resolucion de informacion por parte del coordinador con respuesta de consejo',
